...
(function (global) {
    ...
    /**
     * Extrai as palavras de uma sentença com suas posições de caracteres de início e fim.
     * @param {string} sentence Frase de entrada
     * @returns {Array<{ word: string, cleanWord: string, startChar: number, endChar: number, index: number }>}
     */
    function getSentenceWords(sentence) {
        ...
        while ((match = regex.exec(sentence)) !== null) {
            ...
            // Remove pontuação de borda para extrair a palavra "limpa" para exibição e pronúncia
